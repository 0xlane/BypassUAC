...
:bl
echo.
@echo .NET DllExport v1.7.0.60761+0a002a7
...
if defined as (
(copy /B/Y "!wPkgPath!\\DllExport.bat" "!al!" > nul) && ( echo Manager has been updated. & exit/B 0 ) || ( (echo -mgr-up failed:!av! 1>&2) & exit/B 1 )
)
exit/B !av!
:bx
...
:b6
call :ca
call %bd% %bb% /nologo /p:wpath="%cd%/" /v:m /m:4 %bc%
set "bd="
set bf=%ERRORLEVEL%
del /Q/F %bb%
exit/B %bf%
